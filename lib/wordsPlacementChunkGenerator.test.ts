...
2. Someone is threatening to go to war.`,
      ...
      {
        targetExample: "threat of terrorism",
        chunks: [
      ...
      {
        targetExample: "Someone is threatening to go to war.",
        chunks: [
...
2. The "offender" and the "victim" usually see the event differently`,
      ...
      {
        targetExample: "the victims of war",
        chunks: [
      ...
      {
        targetExample: 'The "offender" and the "victim" usually see the event differently',
        chunks: [
          { id: "victim-2-chunk-1", text: 'The "offender" and the', type: "sentence_chunk", order: 1 },
          { id: "victim-2-chunk-2", text: '"victim"', type: "answer", order: 2 },
          { id: "victim-2-chunk-3", text: "usually see the", type: "sentence_chunk", order: 3 },
          { id: "victim-2-chunk-4", text: "event differently", type: "sentence_chunk", order: 4 },
        ],
      },
    ]);
  });
  ...
  it("does not generate standalone punctuation chunks", () => {
    ...
    expect(result[0]?.chunks.some((chunk) => chunk.text === ".")).toBe(false);
  });
});
